...
Собрание и настройки
/stats — статистика по речам и докладчикам

Админ
/grant @username [собрание] [день] [HH:MM] — выдать доступ (для нового собрания день и время обязательны)

/cancel — отмена пошаговой операции (если она активна)
/help — эта справка
`.trim();
